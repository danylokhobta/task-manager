...
export class TaskModel {
  ...
  async getTasksModel(userId: number) {
    try {
  ...
  async getTaskModel(taskId: string) {
    try {
  ...
  // Create a new task
  async createTaskModel(data: { userId: number, title: string, description: string}) {
  ...
  async updateTaskModel(data: { userId: number, taskId: string, title: string, description: string, is_done: boolean}) {
  ...
  // Delete a task
  async deleteTaskModel(taskId: string) {
    try {
